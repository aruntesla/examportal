...
if(Button != null)
{
	if(Button.equals("LOGIN"))
	{
		...
		try
		{
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost/examportal", "root", "root");
			String qu = "select * from register where email='"+email+"' and pass='"+pass+"'";
			...
			while(r.next())
			{
				id = r.getInt(1);
				name = r.getString(2);
				emailcheck=r.getString(3);
				passcheck=r.getString(4);
				
			}	
			
			if(emailcheck.equals(email)&&passcheck.equals(pass))
			{
